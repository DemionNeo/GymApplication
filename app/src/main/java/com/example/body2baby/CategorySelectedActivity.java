...
//        setSupportActionBar(toolbar);
        ...
        if (getIntent().getExtras() !=null){
            ...
            getSupportActionBar().setTitle("Trimester"+ title);


            if (title.equals("Compatible")){
                getCompatibleUsers();
                getSupportActionBar().setTitle("Compatible");
            }else {
                readUsers();
            }
    ...
    private void getCompatibleUsers() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String timester = snapshot.child("trimester").getValue().toString();

                DatabaseReference reference = FirebaseDatabase.getInstance().getReference()
                        .child("users");
                Query query = reference.orderByChild("search").equalTo(result+timester);
